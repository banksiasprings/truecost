...
const VehicleDetail = {
  ...
  async render(params = {}) {
    ...
    // ── Insurance CTA ──
    '<div class="card" style="margin-top:var(--space-4);border:1.5px solid #e5e7eb">' +
      '<div style="display:flex;align-items:center;gap:12px;margin-bottom:var(--space-3)">' +
        '<span style="font-size:2rem">🛡️</span>' +
        '<div>' +
          '<div style="font-weight:700;color:var(--color-text)">Get an insurance quote</div>' +
          '<div style="font-size:var(--font-size-sm);color:var(--color-text-muted)">Pre-filled for this vehicle — takes 60 seconds</div>' +
        '</div>' +
      '</div>' +
      '<a class="btn btn-primary btn-full btn-pill" ' +
